        ...
        <div key={property._id} className={styles.formContainer}>
          <form>
            <div className={styles.formGroup}>
              <label htmlFor={`propreiterName-${property._id}`}>Proprietor Name</label>
              <input
                type="text"
            ...
            <div className={styles.formGroup}>
              <label htmlFor={`propreiterContact-${property._id}`}>Proprietor Contact</label>
              <input
                type="text"
            ...
            <div className={styles.formGroup}>
              <label htmlFor={`propreiterEmail-${property._id}`}>Proprietor Email</label>
              <input
                type="email"
